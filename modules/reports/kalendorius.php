        ...
        globalModalEl.addEventListener('shown.bs.modal', function () {
            if (!globalCalendar) {
                ...
                globalCalendar = new FullCalendar.Calendar(globalCalendarEl, {
                    ...
                    // NAUJA: Paspaudus ant tuščios dienos langelio
                    dateClick: function(info) {
                        <?php if ($is_admin_global): ?>
                            ...
                            // Nukreipti į olimpiados pridėjimo formą su pre-filled data
                            window.location.href = baseUrl + '/modules/admin/olympiad_add.php?data=' + info.dateStr;
                        <?php endif; ?>
                    }
                });
...
.fc-daygrid-day:hover { cursor: pointer; background-color: rgba(13, 110, 253, 0.05); }
