...
$user_school = null;
if (!is_admin()) {
    $stmt = db_query("SELECT var_mokykla FROM vartotojas WHERE vart_id = ?", [$_SESSION['user_id']], 's');
    $user = db_get_row($stmt);
    if (!$user || empty($user['var_mokykla'])) {
        set_message('Mokykla nenurodyta.', 'error');
        ...
        <div class="col-12">
            <div class="card shadow">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo SITE_URL; ?>/modules/reports/index.php" class="btn btn-light">Grįžti</a>
                </div>
                <div class="card-body">
