...
if ($print_mode && !empty($grouped_participants)) {
    ...
    echo '<style>
        @media print {
            .olympiad-section { page-break-before: always; }
            .olympiad-section:first-child { page-break-before: avoid; }
            .olympiad-title { text-align: center; font-size: 18px; font-weight: bold; margin-bottom: 10px; }
    ...
    foreach ($grouped_participants as $olympiad => $participants) {
       ...
       // echo '<div class="olympiad-title">' . htmlspecialchars($olympiad) . '</div>';
      //  echo '<div class="protocol-number">Protokolo Nr. _________</div>';
