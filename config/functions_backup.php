        ...
        <div class="container">
            <div class="header">
                    <div class="stat active">
                        ...
                        <div class="stat-label">Aktyvūs konkursai</div>
                    </div>
                    <div class="stat inactive">
                        <div class="stat-number" style="color: #6c757d"><?= $inactive_count ?></div>
                        <div class="stat-label">Neaktyvūs konkursai</div>
                    </div>
                    <div class="stat">
