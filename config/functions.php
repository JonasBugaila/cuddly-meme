...
function calculate_rows_per_page($layout, $reserve_footer = false) {
    ...
    // NAUJA (STRUKTŪRINIS SPRENDIMAS): 15mm juosta puslapio numeriui rezervuojama
        ...
        @media print {
            ...
            .page-number {
                /* PATAISYTA #4: naudojame position:fixed (ne absolute/flexbox) -
                   ...
                   fiksuotu rezervo dydžiu (žr. $page_number_reserve_mm kintamąjį
                   aukščiau), numeris atsiduria virš rezervuotos tuščios juostos -
                   niekada nepersidengia su turiniu ir niekada nepatenka į atskirą
                   tuščią puslapį. */
                position: fixed;
                bottom: 0;
                left: 0;
