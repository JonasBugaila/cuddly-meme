    ...
    $html .= '<style>
        ...
        @media print {
            ...
            .print-wrapper {
                ...
                /* PATAISYTA #8: flexbox bandomas dar kartą - ankstesnis nepavykimas
                   (numeris rodydavosi tik kas kelias duomenų "porcijas") greičiausiai
                   buvo susijęs su NETEISINGU eilučių/puslapyje įverčiu (19, kai
                   realiai telpo tik 12) - turinys persiliedavo už apskaičiuoto
                   konteinerio min-height ribų, ir TADA page-break-after tapdavo
                   nepatikimas. Dabar (žr. calculate_rows_per_page() - koeficientas
                   pataisytas į realistiškesnį) turinys turėtų patikimai tilpti į
                   apskaičiuotą aukštį, todėl margin-top:auto turėtų veikti be
                   persiliejimo. Aukštis atitinka TĄ PATĮ plotą, kurį naudoja
                   calculate_rows_per_page() savo skaičiavime. */
