...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // === 5. CHART.JS INICIALIZAVIMAS (VIENAME BLOKE!) ===
    function initCharts() {
        if (typeof Chart === 'undefined') {
            console.warn('Chart.js dar neįkeltas...');
...
// === Kitos funkcijos (už DOMContentLoaded ribų) ===
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (showBtn && iframeCard) {
        showBtn.addEventListener('click', function () {
            ...
            showBtn.style.display = 'none'; // paslepia mygtuką
        });
    }
    ...
    if (hideBtn && iframeCard) {
        hideBtn.addEventListener('click', function () {
            ...
            showBtn.style.display = 'inline-block'; // parodo mygtuką
        });
    }
});
